...
legend("top", bty = "n", expression(italic(P)~'= 0.41'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.24,'~italic(P)~'= 0.086'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.86'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.10'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.12,'~italic(P)~'= 0.097'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.85'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.35,'~italic(P)~'= 0.002'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.52'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.18,'~italic(P)~'= 0.034'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.95'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.27,'~italic(P)~'= 0.030'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.13'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.27,'~italic(P)~'= 0.036'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.23,'~italic(P)~'= 0.015'))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.17,'~italic(P)~'= 0.053'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.67'))
...
legend("top", bty = "n", expression(italic(P)~'= 0.51'))
...
df$reg<-df$med1
df$yy<-df$SS
plot(df$yy ~ df$reg, xlim = c(m1.ll, m1.ul), ylim = c(35,175), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(50,175,25))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.23,'~italic(P)~'= 0.014'))
...
df$reg<-df$r1
df$yy<-df$SS
plot(df$yy ~ df$reg, xlim = c(r1.ll, r1.ul), ylim = c(35,175), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(50,175,25), labels = F)
...
legend("top", bty = "n", expression(italic(P)~'= 0.63'))
...
df$reg<-df$med2
df$yy<-df$SS
plot(df$yy ~ df$reg, xlim = c(m2.ll, m2.ul), ylim = c(35,175), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(50,175,25), labels = F)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.32,'~italic(P)~'= 0.004'))
...
df$reg<-df$r2
df$yy<-df$SS
plot(df$yy ~ df$reg, xlim = c(r2.ll, r2.ul), ylim = c(35,175), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(50,175,25), labels = F)
...
legend("top", bty = "n", expression(italic(P)~'= 0.98'))
...
axis(1, cex.axis = 1.2, las = 2, at = seq(-5,2,1),labels = F)
...
legend("top", bty = "n", expression(italic(P)~'= 0.73'))
...
axis(1, cex.axis = 1.2, las = 2, at = seq(2,8,1), labels = F)
...
legend("top", bty = "n", expression(italic(P)~'= 0.97'))
...
axis(1, cex.axis = 1.2, las = 2, at = seq(-0.6,0.6,0.2),labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(5,17,2), labels = F)
...
legend("top", bty = "n", expression(italic(P)~'= 0.89'))
legend("topleft", "A)", bty = "n", cex = 1, adj = 1.25)
...
axis(1, cex.axis = 1.2, las = 2, at = seq(2,10,2), labels = F)
axis(2, cex.axis = 1.1, las = 2, at = seq(5,17,2), labels = F)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.14,'~italic(P)~'= 0.088'))
legend("topleft", "B)", bty = "n", cex = 1, adj = 1.25)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.44,'~italic(P)~'< 0.001'))
legend("topleft", "C)", bty = "n", cex = 1, adj = 1.25)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.20,'~italic(P)~'= 0.025'))
legend("topleft", "D)", bty = "n", cex = 1, adj = 1.25)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.24,'~italic(P)~'= 0.028'))
legend("topleft", "E)", bty = "n", cex = 1, adj = 1.25)
...
legend("top", bty = "n", expression(italic(P)~'= 0.92'))
legend("topleft", "F)", bty = "n", cex = 1, adj = 1.25)
...
df$reg<-df$med1
df$yy<-df$LW
plot(df$yy ~ df$reg, xlim = c(m1.ll, m1.ul), ylim = c(0,8), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, at = seq(-5,2,1),
     labels = c("Warmer -5","-4","-3","-2","-1","0",
                "1","Cooler 2"))
axis(2, cex.axis = 1.1, las = 2, at = seq(0,8,2))
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.64,'~italic(P)~'< 0.001'))
legend("topleft", "G)", bty = "n", cex = 1, adj = 1.25)
...
df$reg<-df$r1
df$yy<-df$LW
plot(df$yy ~ df$reg, xlim = c(r1.ll, r1.ul), ylim = c(0,8), pch = NA, axes = F, xlab = "", ylab = "")
axis(1, cex.axis = 1.2, las = 2, at = seq(2,8,1))
axis(2, cex.axis = 1.1, las = 2, at = seq(0,8,2), labels = F)
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.48,'~italic(P)~'< 0.001'))
legend("topleft", "H)", bty = "n", cex = 1, adj = 1.25)
...
df$reg<-df$med2
df$yy<-df$LW
plot(df$yy ~ df$reg, xlim = c(m2.ll, m2.ul), ylim = c(0,8), pch = NA, axes = F, xlab = "", ylab = "")
...
legend("top", bty = "n", expression(italic(R)^2~'= 0.29,'~italic(P)~'= 0.007'))
legend("topleft", "I)", bty = "n", cex = 1, adj = 1.25)
...
df$reg<-df$r2
df$yy<-df$LW
plot(df$yy ~ df$reg, xlim = c(r2.ll, r2.ul), ylim = c(0,8), pch = NA, axes = F, xlab = "", ylab = "")
...
legend("top", bty = "n", expression(italic(P)~'= 0.56'))
legend("topleft", "J)", bty = "n", cex = 1, adj = 1.25)
